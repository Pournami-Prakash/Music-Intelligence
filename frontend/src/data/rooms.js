export const ROOMS = {
  'deep-map': {
    ...
    features: [
      ...
      ['Genre Weather', '/genre-weather', 'Watch genre regions drift, merge, and heat up.', {}, 'CloudRain'],
      ['Ancestry', '/ancestry', 'Trace musical lineage backward and forward.', {}, 'GitBranch'],
      ['Forensics', '/forensics', 'Inspect whether a playlist looks organically curated.', {}, 'Search'],
    ],
  },
  'artist-observatory': {
    ...
    features: [
      ...
      ['Main Character', '/main-character', 'How central an artist sits in playlist culture.', { query: 'Taylor Swift' }, 'TrendingUp'],
  ...
  'song-world': {
    ...
    features: [
      ...
      ['Contradiction', '/mood-contradiction', 'Songs that show up where they emotionally should not.', { mood: 'sad' }, 'Zap'],
      ['Guilty Map', '/guilty-pleasure', 'Tracks that survive every context and taste identity.', {}, 'Heart'],
  ...
  'taste-tunnel': {
    ...
    features: [
      ['Six Degrees', '/six-degrees', 'Find the shortest playlist path between two artists.', { from: 'Drake', to: 'Radiohead' }, 'Network'],
      ['Compass', '/compass', 'Map the artists orbiting a central artist.', { artist: 'The Weeknd' }, 'Compass'],
      ['Collision', '/collision', 'How much two artists\' audiences overlap.', { a: 'Taylor Swift', b: 'Kendrick Lamar' }, 'Swords'],
